...
public class SpawnaPersonagensNosTilesAmigo : MonoBehaviour
{
    [SerializeField] private List<GameObject> personagensPrefabs = new();
    [SerializeField] private Tilemap tilemap;
    public List<GameObject> aliadosInstanciados = new();
    ...
    private void SpawnarPersonagens()
    {
        ...
        int quantidadeParaSpawnar = Mathf.Min(personagensPrefabs.Count, celulasValidas.Count); List<Vector3Int> posicoesEscolhidas = new List<Vector3Int>();
        ...
        for (int i = 0; i < quantidadeParaSpawnar; i++)
        {
            ...
            aliadosInstanciados.Add(personagem); 
        ...
        ControladorDeSelecao seletor = FindObjectOfType<ControladorDeSelecao>();
        if (seletor != null)
        {
            seletor.DefinirAliados(aliadosInstanciados);
        }
